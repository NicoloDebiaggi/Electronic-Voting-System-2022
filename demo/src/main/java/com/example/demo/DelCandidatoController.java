...
public class DelCandidatoController {
    @FXML
    ...
    public void removeButtonOnAction(ActionEvent e) {
        ...
        if(dao.retrieveCandidato(cfTextField.getText())!=null) {
            dao.deleteCandidato(cfTextField.getText());
            alertLabel.setText("");
            confLabel.setText("CANDIDATO ELIMINATO");

        } else {
            confLabel.setText("");
            alertLabel.setText("CANDIDATO NON ESISTENTE");
        }
        alertLabel.setText("");
